...
if [[ "$CONFIGURATION" == "devel" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/T21Button/T21Button.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21EnvironmentSwift/T21EnvironmentSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21HTTPRequester/T21HTTPRequester.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21KeyboardState/T21KeyboardState.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21LoggerSwift/T21LoggerSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21Mapping/T21Mapping.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21MaterialTextField/T21MaterialTextField.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21Notifier/T21Notifier.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21PullToRefreshController/T21PullToRefreshController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21RealmStoreSwift/T21RealmStoreSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21RxAdditions/T21RxAdditions.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/T21SortingDescriptorSwift/T21SortingDescriptorSwift.framework"
...
if [[ "$CONFIGURATION" == "pro_debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Kingfisher/Kingfisher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MBProgressHUD/MBProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Marshal/Marshal.framework"
